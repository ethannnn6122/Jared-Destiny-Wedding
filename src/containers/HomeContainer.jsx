                        ...
                        >
                            <div className={classes.textOverlay}>
                                ...
                                <Link to={item.linkPath}>
                                    <Button className={item.btnClass} size={item.btnSize} type={item.btnType}>{item.btnText}</Button>
                                </Link>
                                <p className={item.subTextClass}>WEDDING DATE at 4:00pm</p>
                                <p className={item.subTextClass} >Any questions, please contact us at <a href={"mailto:info@DOMAIN.com"}>info@DOMAIN.com</a></p>
                            </div>
                        </div>
                    ))}
                </Carousel>
